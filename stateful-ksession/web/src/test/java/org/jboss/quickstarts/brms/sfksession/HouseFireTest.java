...
import org.jboss.quickstarts.brms.sfksession.controller.HouseController;
...
public class HouseFireTest {
    ...
    public static Archive<?> getDeployment() {
        ...
        File[] libs = Maven.resolver()
            .loadPomFromFile(pom)
            .resolve("org.kie:kie-api", "org.kie:kie-ci", "org.jboss.quickstarts.brms:brms-stateful-ksession-kmodule")
